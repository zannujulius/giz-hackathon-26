...
const Home: React.FC = () => {
  ...
  const dataTopics = [
    {
      ...
      description: "Policies, laws & mainstreaming strategies",
      color: "purple",
      count: 14,
    },
    {
      ...
      description: "Prevention, legal frameworks & response",
      color: "red",
      count: 10,
    },
    {
      ...
      description: "District-level gender profile reports",
      color: "blue",
      count: 9,
    },
    {
      ...
      description: "Child rights, online safety & labour",
      color: "orange",
      count: 3,
    },
    {
      ...
      description: "Economic development & leadership",
      color: "green",
      count: 2,
    },
    {
      ...
      description: "Family welfare & social safety nets",
      color: "indigo",
      count: 2,
    },
    {
      ...
      icon: "🏛️",
      title: "Governance",
      description: "Women in leadership & local government",
      color: "pink",
      count: 1,
    },
    {
      ...
      description: "Family promotion & child rights",
      color: "yellow",
      count: 1,
    },
    {
      id: 9,
      icon: "🌍",
      title: "Gender Commitments",
      description: "International monitoring & reporting",
      color: "green",
      count: 1,
    },
  ];
  ...
  const handleTopicClick = (topicTitle: string) => {
    // Navigate to catalogue with topic as URL parameter
    navigate(`/catalogue?topic=${encodeURIComponent(topicTitle)}`);
  };
  ...
  return (
    <div className="min-h-screen ">
      ...
      <div className="mx-auto ">
        ...
        <div className="bg-primary px-6 pb-12 pt-12">
          <div className="grid bg-primary p-4 max-w-6xl rounded-2xl gap-10 lg:grid-cols-1">
            <div>
          ...
          <div className="grid gap-6 mt-6 lg:grid-cols-3">
            {dataTopics.map((topic) => (
              <div
                ...
                className="rounded-lg shadow-md border border-gray-100 p-4 bg-white hover:shadow-lg transition-shadow cursor-pointer"
              >
                {/* Category Header */}
                <div
